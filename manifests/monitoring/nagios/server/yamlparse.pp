  ...
  lookup('pocketprotector::monitoring::nagios::resources.host',undef,deep,undef).each | String $nagioshost, Hash $hosthash | {
    @@nagios_host {
      $nagioshost:
        ...
        failure_prediction_enabled   => lookup("pocketprotector::monitoring::nagios::resources.host.${nagioshost}.failure_prediction_enabled",undef,deep,undef),
        hostname                     => lookup("pocketprotector::monitoring::nagios::resources.host.${nagioshost}.hostname",undef,deep,undef),
